...
function setRigth(year,yue,day){
	...
	szrq.style.marginTop="0px";
	var span2=newElement('span');
	span2.innerHTML="<h5 style='text-align:center;'>今日值班</h5><span style='text-align:center; display: block; font-size:14px;'>带班人员： 周伟</span><span style='text-align:center; display: block; font-size:12px;line-height: 24px;'>值班提醒</span><span style='text-align:center; display: block; font-size:12px;line-height: 24px;'>值班人员：付靖伟</span><h6 style='text-indent:24px;'>入冬以来天气变化较快，降水比历年同期也多，需要加班人员实时设备运行情况，发现预警随时通报香瓜相关人员并做好值班日志填写工作。</h6>";
